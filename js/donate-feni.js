...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    const donateBalance = getTextValueById("donate-feni-balance");
    const donateReason =
      document.getElementById("donate-reason-feni").innerText;
    ...
    if (!isNaN(inputNumber)) {
      if (inputNumber <= accountBalance) {
        ...
        document.getElementById("donate-feni-balance").innerText =
          donateNewBalance;
